            ...
            :(
              <View style={styles.home}>  
                  ...
                  <View style={{                     
                    ...
                    <TouchableOpacity style={styles.RoundStyle} activeOpacity={0.8} onPress={appleSignIn}>
                        <View style={styles.btnContainer}>                                 
                            <Image resizeMode='cover'  source={require(APPLE_LOGO)} style={{marginLeft: 20}} />                                  
                            <Text style={styles.btnText}>Apple로 로그인</Text>
                        </View>
                    </TouchableOpacity>                          
                    <TouchableOpacity style={styles.RoundStyle} activeOpacity={0.8} onPress={googleSignIn}>
                        <View style={styles.btnContainer}>                                 
                            <Image resizeMode='cover'  source={require(GOOGLE_LOGO)} style={{marginLeft: 20}}/>                                  
